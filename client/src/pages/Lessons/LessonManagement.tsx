...
const LessonManagement: React.FC = () => {
  ...
  const fetchVideos = async () => {
    try {
      ...
      console.error(`Failed to load videos for`, error);
    } finally {
    }
  };
  ...
  const stats = {
    ...
    publish: lessons.filter((l) => l.status === "publish").length,
    draft: lessons.filter((l) => l.status === "draft").length,
    totalViews: lessons.reduce((sum, l) => sum + l.view, 0),
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Quản lý và theo dõi tất cả các bài học video của bạn
          </p>
        </div>
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between text-sm text-gray-500 pt-3 border-t border-gray-100">
                  <div className="flex items-center gap-1">
                    ...
                    <span>{lesson.view.toLocaleString()} views</span>
                  </div>
                  <div className="flex items-center gap-1">
